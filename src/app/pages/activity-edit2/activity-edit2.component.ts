 ...
 */
@Component({
    selector: 'app-activity-edit2',
    templateUrl: 'activity-edit2.component.html',
    styleUrls: ['activity-edit2.component.css']
})
export class ActivityEdit2Component implements OnInit {
    item: any = {};
